<template>
    <div class="login">
        ...
        <div class="el-login-footer">
            <span>Copyright © 2024 - {{ new Date().getFullYear() }} By D1lete</span>
        </div>
    </div>
</template>
...
.login {
    ...
    align-items: center;
    height: 100%;
    background-image: url("https://upload.d1lete.online//photo/d4ee8cf6adf5918de7528e7788528bd1.jpg");
